...
var fbApp = firebase.initializeApp({
  apiKey: "AIzaSyBAxzmkmAEsSeyVqNxh6RLQYjGe5cw1WNA",
  authDomain: "fhem-assistant-action.firebaseapp.com",
  databaseURL: "https://fhem-assistant-action.firebaseio.com",
  projectId: "fhem-assistant-action",
  storageBucket: "fhem-assistant-action.appspot.com",
  messagingSenderId: "944850022791"
});
...
const CODE_REDIRECT_URI = "https://europe-west1-fhem-assistant-action.cloudfunctions.net/api/codelanding";
const FB_CUSTOM_TOKEN_URI = "https://europe-west1-fhem-assistant-action.cloudfunctions.net/api/firebase";
const REPORT_STATE_ALL = "https://europe-west1-fhem-assistant-action.cloudfunctions.net/api/reportstateall";
const AUDIENCE_URI = "https://us-central1-fhem-testsignin.cloudfunctions.net";
const CLIENT_ID = "dLNaW2C3TYd19Jfhtc9A0617cQ33IuKL";
const AUTH0_DOMAIN = "https://9jr6lwwzfn.eu.auth0.com";
